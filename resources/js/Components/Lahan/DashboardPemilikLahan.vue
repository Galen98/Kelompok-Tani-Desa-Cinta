...
<template>
    <h2 class="text-lg font-medium text-gray-900 mb-3">Daftar Lahan Anda</h2>
    ...
    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
      <div class="overflow-hidden">
        ...
        <tr class="border-b border-gray-400 dark:border-gray/10" v-else v-for="(item, index) in lahan" :key="index">
          ...
          <td class="whitespace-nowrap px-6 py-4 font-medium capitalize">
            <Link :href="`/lahanpemilik/${item.lahan.id}`" type="button" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">Lihat Progress Lahan</Link>
          </td>
        </tr>
        </tbody>
        </table>
