...
const data = prop.lahan.data;
const currentPage = usePage().props.lahan.current_page
const prev_page = usePage().props.lahan.prev_page_url
const next_page = usePage().props.lahan.next_page_url
      ...
      <div class="overflow-hidden">
        <table
          ...
          <tbody>
            ...
            <td class="whitespace-nowrap text-center px-6 py-4 font-medium" colspan="4">Data Kosong</td>    
            </tr>
            ...
            <Link :href="`/dashboard/lahan-page/manage/${item.id}`" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
